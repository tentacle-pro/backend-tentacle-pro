...
const defaultConfig = {
  ...
  styles: {
    ...
    p: 'mt-0 mb-5 leading-relaxed text-base',
    blockquote: 'border-l-4 border-gray-400 pl-4 italic text-gray-600 bg-gray-50 pt-2 pb-2 mt-0 mb-5',
    ...
    ul: 'mt-0 mb-5 list-disc list-outside pl-10',
    ol: 'mt-0 mb-5 list-decimal list-outside pl-10',
    li: 'mt-0 mb-2',
    strong: 'font-bold',
    em: 'italic',
...
const overseasUnicornConfig = {
  ...
  styles: {
    ...
    p: 'mt-0 mb-5 leading-8 text-[16px] text-gray-800',
    blockquote: 'mt-0 mb-5 pl-4 pt-2 pb-2 border-l-4 border-[var(--brandColor)] bg-gray-50 text-gray-700 italic',
    ...
    pre: 'mt-0 mb-5 p-4 rounded-lg overflow-x-auto bg-gray-900 text-gray-100',
    ul: 'mt-0 mb-5 list-disc list-outside pl-10',
    ol: 'mt-0 mb-5 list-decimal list-outside pl-10',
    li: 'mt-0 mb-2 leading-8 text-[16px] text-gray-800',
